        ...
        <div className="relative z-20 flex flex-col items-start -ml-0 -mt-16">
          <div className="w-[810px] max-[1200px]:w-full py-4 px-2">
            ...
            <div className="flex items-center justify-between p-2 border-b border-black text-white bg-black pb-2 px-4 rounded-t">
              ...
              <div className="flex gap-2 max-[1200px]:hidden">
                <button
                  onClick={scrollLeft}
            ...
            {/* Scrollable / Stacked Events */}
            <div
              ref={scrollRef}
              className="
                flex overflow-x-auto bg-[#f5ede4] divide-x divide-gray-400
                max-[1200px]:flex-col max-[1200px]:divide-x-0 max-[1200px]:divide-y
              "
            >
              {[...Array(5)].map((_, idx) => (
                <div
                  key={idx}
                  className="
                    flex items-center gap-4 px-4 py-4 min-w-[400px]
                    max-[1200px]:min-w-full
                  "
                >
                  <div
