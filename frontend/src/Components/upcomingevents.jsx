        ...
        <div className="relative max-w-[1750px] mx-auto px-6 mt-0 pb-[40px]">
          <div className="flex flex-col md:flex-row justify-between items-start gap-5 mb-30">
            ...
            <div className="text-start max-w-[850px] mr-6 mt-20">
              ...
              >
                At United Ummah, every gathering is more than just an event — it’s a
                chance to strengthen bonds, share blessings, and grow together in
        ...
        <div className="block sm:hidden px-4">
          {events.map((event) => (
            <div key={event.id} className="mb-10">
              <div
                className="w-full h-[300px] rounded-t-[40px] overflow-hidden shadow-lg"
                style={{
              ...
              <div className="mt-4">
                <h2
                  className="text-gray-800 mb-1 text-[28px] font-bold"
                  style={{ fontFamily: "Times New Roman, serif" }}
                >
                  {event.title}
                </h2>
                <p
                  className="text-gray-600 text-right mb-2 text-[20px]"
                  style={{ fontFamily: "Times New Roman, serif" }}
                >
                  {event.date}
                </p>
